...
export default Effect.gen(function* () {
  ...
  yield* sql`
    CREATE TABLE IF NOT EXISTS mimic_databases (
  ...
  yield* sql`
    CREATE TABLE IF NOT EXISTS mimic_database_credentials (
      id VARCHAR(36) NOT NULL PRIMARY KEY,
  ...
  yield* sql`
    CREATE TABLE IF NOT EXISTS mimic_collections (
      id VARCHAR(36) NOT NULL PRIMARY KEY,
      database_id VARCHAR(36) NOT NULL,
  ...
  yield* sql`
    CREATE TABLE IF NOT EXISTS mimic_document_wal (
